export default class AudioPlayer {
  ...
  initActions() {
    ...
    timeline.addEventListener('click', (e) => {
      ...
      this.audio.currentTime = ((e.offsetX / parseInt(timelineWidth, 10)) * this.audio.duration);
    });
  ...
  playNext() {
    const trackLength = Object.keys(this.tracks).length - 1;
  ...
  addTrackList() {
    ...
    const trackListItems = this.audioPlayer.querySelectorAll('.track-list .item');
